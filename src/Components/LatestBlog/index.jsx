...
const LatestBlog = ({ Title, heading, paragraph, imgURL }) => {
    return (
        <>
            <NavLink to={Title} className=" w-min m-10">
                <section className="containers box-border flex flex-col md:flex-row items-center justify-between h-[50vh] w-[80vw] md:w-[85vw] md:h-[60vh] rounded-lg bg-gray-200  borderShadow">
